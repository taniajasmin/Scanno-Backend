...
# # You analyze vehicle inspection reports that may include both Arabic and English text.

# # Guidelines:
# # - If report text is Arabic, respond in Arabic (neutral Gulf tone).
...
# #                     {
# #                         "type": "text",
# #                         "text": "Analyze this car inspection report image and respond in JSON only."
# #                     },
# #                     {
# #                         "type": "image",
...
# @retry(stop=stop_after_attempt(3), wait=wait_exponential(multiplier=1, min=4, max=10))
# def analyze_with_gpt_text(text: str, client):
#     response = client.chat.completions.create(
#         model="gpt-4o",
#         messages=[
#             {"role": "system", "content": "You are Scanno — your smart car inspection expert in Qatar."},
...
#             raw_response = analyze_with_gpt_text(text, client) if text else analyze_with_gpt_vision(file_bytes, client)
...
# ---------------------------------------------------------------------
# Helper: dynamically get OpenAI client from admin_data.json
# ---------------------------------------------------------------------
